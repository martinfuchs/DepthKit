...
Exporting works by rendering a given composition from the perspective chosen in the camera track into a series of PNG frames that can be compiled into a movie using quicktime or after effects. It uses the first camera point as an 'in point' and the last as an 'outpoint.'
...
Once you've selected all the compositions you wish to render, click the "Start Render Batch >>" button and sit back and relax as all the compositions you've qeued up begin to render.
